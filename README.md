...
![Solarized+Powerline](https://raw.github.com/julienlevasseur/powerline-go/main/preview.png)
...
[releases tab](https://github.com/julienlevasseur/powerline-go/releases)
...
```bash
go install github.com/julienlevasseur/powerline-go@latest
```
